...
1. Source the zsh bridge functions:
...
3. Run Claude with default model routing:

```bash
claude
```

4. Override for one command:
...
- Keep your NVIDIA key only in local config (for example `~/.claude/settings.json`).
